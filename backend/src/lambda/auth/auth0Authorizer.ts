...
// To get this URL you need to go to an Auth0 page -> Show Advanced Settings -> Endpoints -> f
const jwksUrl =
  'https://dev-cqqqjinaaii1mf5u.us.auth0.com/.well-known/jwks.json'
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  ...
  logger.info('keyset fetched ===>', signingKeys)
